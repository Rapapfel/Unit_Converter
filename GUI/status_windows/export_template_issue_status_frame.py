...
class file_selctor_issue_status_frame(ctk.CTk):
    def __init__(self):
        super().__init__()
    ...
    def widgets_erstellen(self):
        ...
        self.fehlermeldung = ctk.CTkLabel(self, text="Bitte wählen Sie einen Speicherort für die Vorlage aus.")
...
if __name__ == "__main__":
    app = file_selctor_issue_status_frame()
    app.mainloop()
